...
class PimpinanIzinViewHolder(
    private val notesList: MutableList<IjinModel>,
    private val context: Context,
    private val firestoreDB: FirebaseFirestore

) : RecyclerView.Adapter<PimpinanIzinViewHolder.ViewHolder>(),AnkoLogger {
    ...
    inner class ViewHolder internal constructor(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            kalender = view.findViewById(R.id.baris4)
            tipeijin = view.findViewById(R.id.baris2)
...
//
                    val hari = Date(note.tanggal_izin!!.toDate().time)
                    val  tanggal = Date(note.tanggal_izin!!.toDate().time)
                    val  tahun = Date(note.tanggal_izin!!.toDate().time)

                    val  masuk = Date(note.tanggal_izin!!.toDate().time)
...
//
                ...
                holder.nama.text = "Nama : ${data!!.nama.toString()}"
                    ...
                    holder.tipeijin.text = "Tipe : ${note.tipe_ijin.toString()}"
